...
class _CallPageState extends State<CallPage> {
  ...
  addSphere(ArCoreController _arCoreController) {
  ...
  Widget _viewRows() {
    ...
    switch (views.length) {
      ...
      return Container(
            child: Column(
          children: <Widget>[_videoView(ArCoreView(onArCoreViewCreated: onArCoreViewCreated))],
        ));
      ...
      case 2:
       setState(() {
        ...
        return Container(
            child: Column(
          children: <Widget>[
           _videoView(ArCoreView(onArCoreViewCreated: onArCoreViewCreated)),
